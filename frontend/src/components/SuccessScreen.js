...
const SuccessScreen = ({ paymentDetails = {}, totalPrice, onClose }) => {
    useEffect(() => {
    ...
    return (
        <div className="fixed inset-0 bg-[#0cbf66] z-[9999] flex flex-col items-center justify-between py-12 px-6 text-white animate-in fade-in duration-300 overflow-hidden font-sans">
            ...
            <div className="w-full max-w-sm bg-white rounded-3xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.2)] text-gray-800 transform transition-all hover:scale-[1.02]">
                <div className="flex justify-between items-center mb-1 font-black text-xl text-black border-b border-gray-100 pb-4">
                    <span className="tracking-tighter italic">URBANSHIFT</span>
                ...
                <div className="flex items-center justify-between bg-gray-50 p-4 rounded-2xl border border-gray-100 group">
                    ...
                    <button
                        ...
                        className="p-2 bg-white rounded-full shadow-sm hover:text-yellow-500 transition-colors"
                    >
                        <Copy size={18} />
                    </button>
                </div>
                ...
                <div className="mt-6">
                    <button
                        onClick={onClose}
                        className="w-full bg-black text-white py-3 rounded-xl font-bold uppercase tracking-widest hover:bg-gray-800 transition-colors"
                    >
