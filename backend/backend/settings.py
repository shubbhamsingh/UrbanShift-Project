...
# Media Files (Cloudinary Persistent Storage)
CLOUDINARY_STORAGE = {
...
# ✅ Django 6.0+ Storage Configuration (Replaces DEFAULT_FILE_STORAGE)
STORAGES = {
    "default": {
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '10/minute',  # Anonymous users: 10 requests/min (Stops spam)
