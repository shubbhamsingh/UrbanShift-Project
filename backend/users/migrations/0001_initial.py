    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('BUYER', 'Buyer'), ('SELLER', 'Seller'), ('COMPANY', 'Movers & Packers Company')], default='BUYER', max_length=10)),
                ('phone', models.CharField(blank=True, max_length=15, null=True)),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_document', models.ImageField(blank=True, null=True, upload_to='verification_docs/')),
